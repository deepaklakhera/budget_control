...
var UIController=(function(){
    ...
    return{
        ...
        {
            return{
                type : document.querySelector(DOMstrings.inputType).value , //will beeither inc or exp because it isn't input type
...
var controller=(function(budgetctrl,UIctrl){
    ...
    var ctrlAddItem=function(){
        ...
        if (input.description!=="" && !isNaN(input.value) && input.value>0){
            ...
            updateBudget();
            //6.Calculate and update budget percentage
            updatePercentages();
        }
    };
    ...
    var ctrlDeleteItem=function(event){
        ...
        if(itemID){
            ...
            //4.Calculate and update budget percentage
            updatePercentages();
        }
    }
    return {
